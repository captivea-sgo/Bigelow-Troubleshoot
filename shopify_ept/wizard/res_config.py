...
#    _name = 'shopify.config.settings'
    ...
    def onchange_shopify_instance_id(self):
        ...
        self.is_use_default_sequence = instance and instance.is_use_default_sequence
        #Account Field
        self.shopify_property_account_payable_id = instance and instance.shopify_property_account_payable_id and instance.shopify_property_account_payable_id.id or False
        self.shopify_property_account_receivable_id = instance and instance.shopify_property_account_receivable_id and instance.shopify_property_account_receivable_id.id or False
