...
class shopify_instance_ept(models.Model):
    ...
    exported_product_ids = fields.One2many('shopify.product.template.ept','shopify_instance_id',domain=[('exported_in_shopify','=',True)],string="Exported Product")
    ...
    unpublished_product_ids = fields.One2many('shopify.product.template.ept','shopify_instance_id',domain=[('website_published','=',False),('exported_in_shopify','=',True)],string="Unpublished Products")
    ...
    assigned_picking_ids = fields.One2many('stock.picking','shopify_instance_id',domain=[('state','=','assigned')],string="Assigned Picking")
    ...
    refund_invoice_ids = fields.One2many('account.invoice','shopify_instance_id',domain=[('type','=','out_refund')],string="Refund Invoice")
