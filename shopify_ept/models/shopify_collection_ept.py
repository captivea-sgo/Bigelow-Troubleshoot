...
class shopify_collection_ept(models.Model):
    ...
    def list_all_custom_collections(self,result):
        ...
        new_result=shopify.CustomCollection().find(limit=250,page=2)        
        page_no=2
        while new_result:            
            page_no += 1            
            sum_of_result=sum_of_result+new_result            
            new_result=shopify.CustomCollection().find(limit=250,page=page_no)
        return sum_of_result
    ...
    def list_all_smart_collections(self,result):
        ...
        if not  sum_of_result:            
            return sum_of_result        
        new_result=shopify.SmartCollection().find(limit=250,page=2)        
        page_no=2
        while new_result:            
            page_no += 1            
            sum_of_result=sum_of_result+new_result            
            new_result=shopify.SmartCollection().find(limit=250,page=page_no)
        return sum_of_result
